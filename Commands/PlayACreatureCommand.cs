...
public class PlayACreatureCommand : Command
{
    ...
    public PlayACreatureCommand(CardLogic cl, Player p,
        int tablePos, int creatureID, TablePosition tablePosition)
    {
        this.p = p;
        this.cl = cl;
    ...
    public override void StartCommandExecution()
    {
        ...
        p.PArea.tablesVisuals[(int)tablePosition].AddCreatureAtIndex(cl.ca, creatureID, tablePos);
    }
}
