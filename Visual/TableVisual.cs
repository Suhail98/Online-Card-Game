...
public enum TablePosition { Left, Right }
...
public class TableVisual : MonoBehaviour 
{
    ...
    public static TablePosition? CursorOverTable
    {
        get
        {
            TableVisual[] Tables = GameObject.FindObjectsOfType<TableVisual>();
            foreach(TableVisual table in Tables)
            {
                if (table.cursorOverThisTable) return table.position;
            }
            return null;
        }
    }
